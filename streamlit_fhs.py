...
if button1:
    ...
    st.write('<center><p style="font-size:30px"> ✨ Le vainqueur du combat est<b style = "color:lightblue"> ', df_combat_nom.iloc[0]['Winner'], '</b>✨</p></center>',unsafe_allow_html=True)
    st.write('<hr>',unsafe_allow_html=True  )
